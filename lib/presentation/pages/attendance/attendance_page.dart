            ...
            Container(
              ...
              child: Column(
                ...
                children: const [
                  ...
                  SizedBox(height: 10),
                  Text(
                    "- Presiona 'Iniciar Escanear' para activar la cámara",
                    style: TextStyle(fontSize: 11),
                  ),
                  SizedBox(height: 10),
                  Text(
                    "- Posiciona el código QR frente a la cámara para registrar la asistencia",
                    style: TextStyle(fontSize: 11),
                  ),
                  SizedBox(height: 10),
                  Text(
                  ...
                  SizedBox(height: 10),
                  Text(
                    "- Se envía un email inmediato a los padres",
                    style: TextStyle(fontSize: 11),
                  ),
                  SizedBox(height: 10),
                  Text(
                    "- El registro quedará guardado en el historial",
                    style: TextStyle(fontSize: 11),
                  ),
                ],
              ),
